...
int countNumOfLeafNodes(TreeNode<int>* root){
    ...
    for(int i=0;i<root->children.size();i++){
       totalLeafNodes+=countNumOfLeafNodes(root->children[i]);
    }
...
int main(){
    ...
    cout<<endl<<"Num of leaf nodes:"<<endl;
    cout<<countNumOfLeafNodes(root);
